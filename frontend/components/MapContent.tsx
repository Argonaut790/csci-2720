...
const AllDataPoints = () => {
  return (
    <div id="AllDataPointsSection" className="flex flex-col gap-6 ">
      <h1 className="text-7xl lg:h-20  font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">
        {" "}
        All Data Points
      </h1>
      <div className="">
